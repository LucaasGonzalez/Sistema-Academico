...
#links:visited {
	color: rgb(221, 192, 77); /*Mudamos a cor para Laranja*/
}
...
#links:hover {
	...
	border-radius: 5px;
	box-shadow: 0px 0px 10px 0px rgb(221, 192, 77);
	/*Mudamos a cor para Rosa*/
}

/* Quando clicamos no link */
#links:active {
	color: rgb(221, 192, 77); /*Mudamos a cor para Verde*/
}
</style>
...
<div id="tudo">
	...
	<form action="ServletAluno?cmd=atualizar" method="post" class="form">
	...
	<div id="topo" class="container p-5 my-5 border">
			...
			<table id="conteudo" class="table table-hover">
				...
				<tr>
					...
					<th colspan="2"><input type="submit" class="btn btn-outline-warning btn-lg" value="Confirmar Atualização" /></th>
